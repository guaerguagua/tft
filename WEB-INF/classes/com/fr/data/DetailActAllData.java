...
public class DetailActAllData extends AbstractTableData {
    ...
    private String checkListNames = null;

    public DetailActAllData() {
        //
//		setDefaultParameters(new Parameter[] { new Parameter("trans_cd"),new Parameter("day") });
        ...
        checkListNames  = "settle_dt,buss_no,acct_no,trans_cd,trans_at/100 ,ins_mchnt_cd,rec_crt_ts,charChan,passageWay,current_balance/100,before_balance";
//		transCdTotal="1401,1402,1408";

        columnNames = checkListNames.replaceAll(" ", "").split(",");
